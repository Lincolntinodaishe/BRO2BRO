...
const POSTS: Post[] = [
  {
    ...
    body: "My barber Joe showed me the Pulse QR code and I figured why not. My reading was 148/92 — not great, but I finally know where I stand. Booked an appointment at the UAMS clinic for next week. Just want to share in case someone else is putting it off like I was.",
    likes: 47,
    comments: 12,
    pinned: true,
  },
  {
    ...
    body: "I kept telling myself I didn't need it. Work stress, relationship stuff, all of it building up. The counselor Pulse connected me with works specifically with Black men — that made a difference. Not gonna pretend one session fixed everything, but I feel lighter.",
    likes: 83,
    comments: 21,
  },
  {
  ...
  },
  {
    ...
    body: "We're partnering with UAMS and Pulse to host a free health screening this Saturday, 9AM–2PM. Blood pressure, glucose, BMI — all free, no insurance needed. Bring your crew. 2108 S Chester St, Little Rock.",
    likes: 91,
    comments: 8,
    pinned: true,
  },
